...
void main() {
  ...
  group('updatePetStat', () {
    ...
    test(
      'Throws an exception if trying to update a stat for a pet id that doesnt exist',
      () async {
        expect(
    ...
    test(
      'Throws an exception if trying to update a stat that doesnt exist',
      () async {
        expect(
          () => petStatsDB.updatePetStat(1, 'unknown_level', 1),
          throwsA(isA<Exception>()),
        );
      },
    );
